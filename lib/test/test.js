...
describe('easylink-js Tests', () => {
    describe('EasyLink', () => {
        const easyLink = new src_1.EasyLink(config);
        beforeEach((done) => {
            setTimeout(() => {
                done();
            }, 1000);
        ...
        it('should returns device info', () => __awaiter(this, void 0, void 0, function* () {
            const deviceInfo = yield easyLink.getDeviceInfo();
            chai_1.assert.hasAllKeys(deviceInfo, [
                'Jam', 'Admin', 'User', 'FP', 'CARD', 'PWD', 'All Operasional',
                'All Presensi', 'New Operasional', 'New Presensi'
            ]);
        }));
        it('should returns array of users', () => __awaiter(this, void 0, void 0, function* () {
            const users = yield easyLink.getAllUsers();
            chai_1.assert.isArray(users);
        }));
        it('should uploads a user successfully', () => {
            chai_1.assert.doesNotThrow(() => __awaiter(this, void 0, void 0, function* () {
                yield generateUser(easyLink);
            }));
        });
        it('should deletes all users on machine', () => {
            chai_1.assert.doesNotThrow(() => __awaiter(this, void 0, void 0, function* () {
                yield easyLink.deleteAllUsers();
            }));
        });
        it('should fetches all scan logs successfully', () => __awaiter(this, void 0, void 0, function* () {
            const scanLogs = yield easyLink.getAllScanLogs();
            chai_1.assert.isArray(scanLogs);
        }));
        it('should fetches new scan logs successfully', () => __awaiter(this, void 0, void 0, function* () {
            const scanLogs = yield easyLink.getNewScanLogs();
            chai_1.assert.isArray(scanLogs);
        }));
        it('should deletes scan logs successfully', () => {
            chai_1.assert.doesNotThrow(() => __awaiter(this, void 0, void 0, function* () {
                yield easyLink.deleteAllScanLogs();
            }));
        });
        it('should syncs date/time successfully', () => {
            chai_1.assert.doesNotThrow(() => __awaiter(this, void 0, void 0, function* () {
                yield easyLink.syncDateTime();
            }));
        });
        it('should deletes device logs successfully', () => {
            chai_1.assert.doesNotThrow(() => __awaiter(this, void 0, void 0, function* () {
                yield easyLink.deleteDeviceLogs();
            }));
        });
    });
});
